...
void makeoutput(TString infname, TString ofname, TString mvatype){
   ...
   Int_t           Bsize;
   Float_t         Btrk1Pt[20000];
   Float_t         Btrk2Pt[20000];
   Float_t         Bchi2cl[20000];
   Float_t         BsvpvDistance[20000];
   Float_t         BsvpvDisErr[20000];
   Float_t         Bd0[20000];
   Float_t         Bd0Err[20000];
   Float_t         Bdtheta[20000];
   Float_t         Bmu1pt[20000];
   Float_t         Bmu2pt[20000];
   Float_t         Bpt[20000];
   Float_t         Btktkmass[20000];
   Float_t         Blxy[20000];
   ...
   for (int i=0;i<t->GetEntries();i++){
      t->GetEntry(i);
      //std::cout << "gets entry. Bsize: " << Bsize << "\n";
